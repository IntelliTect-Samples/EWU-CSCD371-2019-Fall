...
namespace Inheritance.Tests
{
    ...
    public class PrinterTests
    {
        ...
        {
            //Arrange
            Television television = new Television { Size = "60" };
        ...
        {
            //Arrange
            Television television = new Television { Manufacturer = "LG" };
        ...
        {
            //Arrange
            Television television = new Television { Size = "60", Manufacturer = "LG" };
        ...
        {
            //Arrange
            Food food = new Food { Upc = "123456789" };
        ...
        {
            //Arrange
            Food food = new Food { Brand = "Kellogs" };
        ...
        {
            //Arrange
            Food food = new Food { Upc = "123456789", Brand = "Kellogs" };
