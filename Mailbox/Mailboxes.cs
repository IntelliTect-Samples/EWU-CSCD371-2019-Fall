namespace Mailbox {
    public class Mailboxes {
        ...
        private bool canOwnBox(Person owner, int x, int y) {
            ...
            //Checking right
            if (x + 1 <= MailboxesArray.Length && MailboxesArray[x + 1, y] != null && MailboxesArray[x + 1, y].Owner.Equals(owner)) {
                return false;
            }
            //Checking left
            ...
            //Checking down
            if (y + 1 <= MailboxesArray.GetLength(0) && MailboxesArray[x, y + 1] != null && MailboxesArray[x, y + 1].Owner.Equals(owner)) {
                return false;
            }
            return true;
        }
